...
# aria2c -x 16 https://dl-cdn.alpinelinux.org/alpine/latest-stable/releases/x86_64/alpine-virt-3.24.2-x86_64.iso
aria2c -x 16 https://mirrors.tuna.tsinghua.edu.cn/alpine/v3.24/releases/x86_64/alpine-xen-3.24.2-x86_64.iso
qemu-img create -f qcow2 alpine_x86_64.qcow2 20G
# qemu-img resize alpine_x86_64.qcow2 100G
qemu-img info alpine_x86_64.qcow2
...
qemu-system-x86_64 \
  -m 2G \
  -smp 2 \
  -drive file=alpine_x86_64.qcow2,if=virtio \
